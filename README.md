...
- **Add update_priority() function.** (threads/thread.c) <br>
- **Donate_priority() function.** (threads/thread.c) <br>
- **Add remove_lock() function.** (threads/thread.c) <br>
- **Modify init_thread() function.** (threads/thread.c) <br>
- **Modify thread_set_priority() function.** (threads/thread.c) <br>
- **Add 'cmp_donation_priority()'.** (threads/synch.h) <br>
